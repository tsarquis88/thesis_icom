...
\begin{figure}[h]
    \includegraphics[width=10cm]{gfx/02_5.3_0.png}
...
\begin{figure}[h]
    \includegraphics[width=10cm]{gfx/02_5.3_1.png}
...
\begin{figure}[h]
    \includegraphics[width=10cm]{gfx/02_5.4_2.png}
...
\begin{figure}[h]
    \includegraphics[width=10cm]{gfx/02_5.4_3.png}
...
\begin{figure}[h]
    \includegraphics[width=10cm]{gfx/02_5.4_4.png}
...
El método elegido es el de \emph{undersampling}. Esta técnica consiste en muestrear la señal por debajo de la frecuencia de \emph{Nyquist} (es decir, por debajo del doble del ancho de banda de la señal). Esto conlleva a que, como se dijo anteriormente, la señal no sea reconstruible y el resultado del muestreo sea un \emph{aliasing} de la señal original.

\begin{figure}[h]
    \centering
    \includegraphics[width=10cm]{gfx/02_6.2_0.png}
...
Se va a explicar el procedimiento para aplicar \emph{undersampling} de la manera correcta y con un ejemplo en el cual se muestrea una señal de 70 MHz con un ancho de banda de 20 MHz (la frecuencia de la señal varía entre 60 MHz y 80 MHz). En muchos casos de aplicaciones de radar, el valor de 70 MHz como frecuencia IF es común, con un ancho de banda que varía entre algunos KHz a unos pocos MHz. \par
...
\begin{figure}[h]
    \centering
    \includegraphics[width=10cm]{gfx/02_6.3_0.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=10cm]{gfx/02_6.3_1.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=10cm]{gfx/02_6.3_2.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=5cm]{gfx/02_6.3_4.png}
